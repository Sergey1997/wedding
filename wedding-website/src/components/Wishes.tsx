...
const wishesData: WishItem[] = [
  {
    ...
    text: 'Наше мероприятие предназначено только для гостей старше 18 лет. Просим вас заранее позаботиться о том, чтобы в этот вечер ваши дети были в надёжных руках.',
    alt: 'Праздник для взрослых 18+',
  },
  {
